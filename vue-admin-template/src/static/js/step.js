  ...
  Step.prototype={
    init:function(){
      ...
      function _initStepCon(i){
        switch (i) {
          case 0:
            location.href="http://13.230.166.63/laravel/public/admin/AddProjecta"
            break;
          case 1:
            location.href="/quick-quote/create-quote"
            break;
          case 2:
            location.href="http://13.230.166.63/laravel/public/admin/AddProjectc"
            break;
          case 3:
